    ...
    <footer className="site-footer mt-8">
      <div className="footer-wrap">
            ...
            {SOCIAL_LINKS.map((link) => (
              <a
                ...
                dangerouslySetInnerHTML={{
                  __html: SOCIAL_ICONS[link.label] ?? "",
                }}
              />
            ))}
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copy">&copy; 2026 Sunny Gong</p>
          <p className="footer-copy">Waterloo, Ontario</p>
        </div>
      </div>
    </footer>
  );
